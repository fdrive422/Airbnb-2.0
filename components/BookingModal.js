...
function BookingModal({
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-white dark:bg-gray-900 rounded-3xl shadow-2xl w-full max-w-lg overflow-hidden max-h-[90vh] overflow-y-auto">
        {/* Header */}
        ...
        <div className="px-4 py-4">
          {/* Date picker */}
          <p className="text-sm font-medium text-gray-700 dark:text-gray-300 mb-2 px-2">
            Select dates
          </p>
          <DateRangePicker
            ranges={dateRange}
          ...
          {/* Guest stepper */}
          <div className="flex items-center justify-between px-4 py-3 mt-2 border dark:border-gray-700 rounded-2xl">
          ...
          <div className="flex gap-3 mt-4 pb-2">
            ...
            <button
              onClick={() => onConfirm({ nights, total: computedTotal })}
